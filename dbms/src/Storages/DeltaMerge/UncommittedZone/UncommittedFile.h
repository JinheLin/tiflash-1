...
{
public:
    static UncommittedFilePtr create(UInt64 start_ts, UInt64 generation, const String & parent_path, PageIdU64 file_id, const RowKeyRanges & valid_ranges);

    UncommittedFile(UInt64 start_ts_, UInt64 generation_, const String & parent_path_, PageIdU64 file_id_, const RowKeyRanges & valid_ranges_);
