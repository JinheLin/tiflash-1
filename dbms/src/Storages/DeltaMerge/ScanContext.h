...
public:
    ...
    std::atomic<uint64_t> rs_pack_filter_total{0};
    std::atomic<uint64_t> rs_pack_filter_need_to_read{0};
    std::atomic<uint64_t> rs_pack_filter_need_to_filter{0};
    ...
    void deserialize(const tipb::TiFlashScanContext & tiflash_scan_context_pb)
    {
        ...
        // TODO: rs_pack_filter_total, rs_pack_filter_need_to_read, rs_pack_filter_need_to_filter
    ...
    void merge(const ScanContext & other)
    {
        ...
        rs_pack_filter_total += other.rs_pack_filter_total;
        rs_pack_filter_need_to_read += other.rs_pack_filter_need_to_read;
        rs_pack_filter_need_to_filter += other.rs_pack_filter_need_to_filter;
