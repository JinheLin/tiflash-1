...
std::atomic<Int64> real_rss{0}, raw_rss{0}, rss_file{0}, memory_control_rss{0}, proc_num_threads{1},
    baseline_of_query_mem_tracker{0};
...
void MemoryTracker::alloc(Int64 size, bool check_memory_limit)
{
    ...
    if (check_memory_limit)
    {
        ...
        const auto current_memory_control_rss = memory_control_rss.load(std::memory_order_relaxed);
        const auto current_raw_rss = raw_rss.load(std::memory_order_relaxed);
                ...
                && current_memory_control_rss > current_accuracy_diff_for_test + current_limit))
        {
            ...
            fmt_buf.fmtAppend(
                ...
                "raw_rss: {}, rss_file: {}, threads of process: {}, "
                ...
                formatReadableSizeWithBinarySuffix(current_raw_rss),
